...
class SignupForm(FlaskForm):
    ...
    password = PasswordField('password', validators=[validators.DataRequired("Password field is required"), validators.Length(min=4, message="Please choose a password of at least 4 characters")])
    password2 = PasswordField('password2', validators=[validators.DataRequired("Confirm password field is required"), validators.EqualTo('password', message='Passwords must match')])
